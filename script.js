...
.then(function(output){
    ...
    getMovie(output.name || output.title);
...
function getMovie(origin_name){
    let film = movie.querySelector('.movie');
    let videoFrame ='<h5 class="col-12 text-info">фильм</h5>';
    videoFrame += '<a href="./player.php?Name='+ origin_name +'"><p>смотреть</p></a>';
    film.innerHTML = videoFrame;
}
